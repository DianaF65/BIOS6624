...
\textit{We will further refer to the electronic monitoring cap as MEM time and the the SPIT Booklet as Booklet time for the remainder of the report.}
...
In our missinginess investigation, we determined that the variable with the highest missingness was MEM Time. This is expected due to cap malfunction from low battery or user error. Booklet Time had much lower missingness compared to MEM time. DHEA and Cortisol measurements did not have a large amount of missingness. 

In regard to the comparison of MEM and Booklet times, MEM and Booklet times had a statistically significant strong linear relationship. Although we did note that booklet times tended to be earlier than MEM times. This could be due to cap malfunction as previously described or could be due to untruthful time logs which is not something we are able to investigate but a possibility with these types of studies. 

For the 30 minute sampling time, the percentages for good and adequate adherence were reasonable and satisfactorily high at around 80% or so. 
For the 600 minute sampling time, we do observe a noticeable decrease for both good and adequate adherence, with both percentages from Booklet and MEM falling below 50%. This is expected as ..
Across these windows and thresholds of adherence, the impact of missingness in MEM time is apparent with lower percentages compared to Booklet time for both the +30 and +60 minute windows and between good or adequate adherence. This emphasizes the importance of appropriately addressing missingness. The differences in MEM and Booklet times would almost certainly present themselves in analysis results. 
In Figure 2, we note the noticeable differences between the distributions of minutes from the target sampling times for the +30 minute and +600 windows as well as the differences between the MEM and Booklet times. All distributions have long right tails - or bigger deviations from the target times. The peaks of the histograms are 0 though, indicating that a majority of subjects did fall within the good and adherence windows. 
